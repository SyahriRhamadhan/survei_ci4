...
<div class="card col-md-12">
    <div class="card-body">
    <a href="<?= base_url('admin/prodi') ?>" class="btn btn-primary mb-3 fs-6">
        ...
        <form method="POST" action="<?= base_url('admin/prodi/update/' . $prodi['id']) ?>">
            ...
            <div class="input-style-1">
                <label class="text-dark mb-2 fs-6">Prodi</label>
                <input value="<?= $prodi['nama'] ?>" class="fs-6 form-control <?= ($validation->hasError('prodi')) ? 'is-invalid' : '' ?>" type="text" name="prodi" placeholder="*Teknik Informatika " />
