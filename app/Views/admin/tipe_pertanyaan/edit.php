    ...
    <a href="<?= base_url('admin/tipe_pertanyaan') ?>" class="btn btn-primary mb-3 fs-6">
        ...
        <form method="POST" action="<?= base_url('admin/tipe_pertanyaan/update/' . $tipe_pertanyaan['id']) ?>">
            ...
            <div class="input-style-1">
                ...
                <input value="<?= $tipe_pertanyaan['tipe_pertanyaan'] ?>" class="fs-6 form-control <?= ($validation->hasError('tipe_pertanyaan')) ? 'is-invalid' : '' ?>" type="text" name="tipe_pertanyaan" placeholder="*Contoh " />
