...
<body class="bg-gray-50 text-gray-800 font-sans leading-normal tracking-normal">
    ...
    <header class="bg-gradient-to-r from-blue-900 to-blue-800 text-white shadow-md fixed w-full z-10">
        <div class="container mx-auto">
            <div class="flex justify-between items-center py-3 px-6">
                ...
                <!-- Button Hamburger for Mobile -->
                <button class="md:hidden text-gray-700 hover:text-blue-900" id="hamburger-button">
        ...
        <div id="sidebar" class="fixed top-0 right-0 w-64 bg-blue-900 text-white h-full z-20 transform translate-x-full transition-transform duration-300">
            <div class="p-4">
                ...
                <nav class="mt-6">
                    ...
                    <a href="<?= base_url('/responden/dashboard') ?>" class="block py-2 bg-white text-blue-900 rounded-full px-4">Survei Sekarang</a>
                </nav>
            </div>
        </div>
    </header>
    ...
    <script>
        // Menangani event ketika tombol hamburger diklik
