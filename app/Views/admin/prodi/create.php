        ...
        <a href="<?= base_url('admin/prodi') ?>" class="btn btn-primary mb-3 fs-6">
            ...
            <form method="post" action="<?= base_url('admin/prodi/store') ?>">
                ...
                <div class="input-style-1">
                    <label class="text-dark mb-2 fs-6">Nama Prodi</label>
                    <input class="fs-6 form-control <?= ($validation->hasError('prodi')) ? 'is-invalid' : '' ?>" type="text" name="prodi" placeholder="*Teknik Informatika " />
