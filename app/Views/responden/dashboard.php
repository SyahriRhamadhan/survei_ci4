                                ...
                                <div class="d-flex align-items-center">
                                    <div>
                                        <div class="d-inline-flex align-items-center">
                                            <h2 class="text-dark mb-1 font-weight-medium">2,578</h2>
                                            <span
                                                class="badge bg-primary font-12 text-white font-weight-medium rounded-pill ms-2 d-lg-block d-md-none">+18.33%</span>
                                        </div>
                                        <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Responden
                                        </h6>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        ...
                                        <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Response Hari Ini</h6>
                                    </div>
                                    <div class="ms-auto mt-md-3 mt-lg-0">
