            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="/admin/pertanyaan">Pertanyaan</a>
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?= base_url('admin/pertanyaan/create') ?>" class="btn btn-primary mb-3 fs-6">
                        ...
                        <table id="zero_config" class="table border table-striped table-bordered text-nowrap">
                            ...
                            <tbody>
                                ...
                                foreach ($pertanyaan as $per) : ?>
                                    <tr>
                                        <td><?= $no++ ?>.</td>
                                        <td><?= htmlspecialchars(substr($per['pertanyaan'], 0, 75)) ?>...</td>
