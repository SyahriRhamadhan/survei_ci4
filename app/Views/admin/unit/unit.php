            ...
            <div class="d-flex align-items-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="/admin/unit">Unit Kerja</a>
                        </li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?= base_url('admin/unit/create') ?>" class="btn btn-primary mb-3 fs-6">
                            ...
                            <tbody>
                                ...
                                foreach ($unit as $per) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url('admin/unit/edit/' . $per['id']) ?>" class="btn btn-primary">Edit</a>
                                            <a href="<?= base_url('admin/unit/delete/' . $per['id']) ?>" class="btn btn-danger tombol-hapus">Delete</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
