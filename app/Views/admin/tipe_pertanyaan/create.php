...
<div class="container-fluid">
    ...
    <div class="card col-md-12">
        <div class="card-body">
            <a href="<?= base_url('admin/tipe_pertanyaan') ?>" class="btn btn-primary mb-3 fs-6">
            ...
            <form method="post" action="<?= base_url('admin/tipe_pertanyaan/store') ?>">
                <?= csrf_field() ?>

                <div class="input-style-1">
                    <label class="text-dark mb-2 fs-6">Tipe/Kategori Pertanyaan</label>
                    <input class="fs-6 form-control <?= ($validation->hasError('tipe_pertanyaan')) ? 'is-invalid' : '' ?>" type="text" name="tipe_pertanyaan" placeholder="*Contoh= Bidang Sarana dan Prasarana, Tata Kelola, Tata Pamong, dan Kerjasama " />
