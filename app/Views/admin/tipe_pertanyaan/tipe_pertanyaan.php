                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="/admin/tipe_pertanyaan">Tipe Pertanyaan</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="<?= base_url('admin/tipe_pertanyaan/create') ?>" class="btn btn-primary mb-3 fs-6">
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table border table-striped table-bordered text-nowrap">
                                        ...
                                        <tbody>
                                        <?php $no = 1;
                                            foreach ($tipe_pertanyaan as $per) : ?>
                                                <tr>
                                                    <td><?= $no++ ?>.</td>
                                                    <td><?= htmlspecialchars($per['tipe_pertanyaan']) ?></td>
                                                    <td>
                                                        <a href="<?= base_url('admin/tipe_pertanyaan/edit/' . $per['id']) ?>" class="btn btn-primary">Edit</a>
                                                        <a href="<?= base_url('admin/tipe_pertanyaan/delete/' . $per['id']) ?>" class="btn btn-danger tombol-hapus">Delete</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
