        ...
        <div class="card-body">
            ...
            <form method="post" action="<?= base_url('admin/fakultas/store') ?>">
                ...
                <div class="input-style-1">
                    <label class="text-dark mb-2 fs-6">Nama Fakultas <span class="text-success">*Tambahkan juga singkatannya cth: FTTK</span></label>
                    <input class="fs-6 form-control <?= ($validation->hasError('fakultas')) ? 'is-invalid' : '' ?>" type="text" name="nama" placeholder="*FTTK" />
