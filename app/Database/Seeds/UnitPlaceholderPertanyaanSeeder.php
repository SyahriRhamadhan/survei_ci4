    ...
    public function run()
    {
        ...
        $unitLayananData = [
            ...
            'Fakultas Keguruan dan Ilmu Pendidikan (FKIP)' => [
                ...
                "Pindah Prodi",
                "Pindah Kampus",
                "Legalisisr Ijazah dan Transkrip",
                "LIRS",
                "LIHS",
                'Pelayanan SK Seminar Proposal dan Sidang Skripsi'
            ],
            'Biro Keuangan dan Umum (BKU)' => [
                "Pencairan Gaji",
                "Pencairan Tunjangan Kinerja ASN",
                "Pencairan Uang Makan ASN dan Non ASN",
                "Pencairan Lembur ASN dan Non ASN",
                "Pencairan honor-honor Dosen dan Tenaga Kependidikan",
                "Pencairan Pengadaan Barang dan Jasa",
                "Pencairan Perjalanan Dinas",
                "Pendaftaran Hibah Bentuk Uang dan Barang",
                "Permohonan Rekening Pengeluaran Lainnya untuk Kerjasama/Hibah/Dana Penampungan Sementara",
                "Verifikasi Berkas SPJ",
                "Pencairan dana untuk kegiatan oleh bendahara pengeluaran",
                "Pembuatan Slip Gaji",
                "Pembuatan Lunas SPP Mahasiswa",
                "Operator Sakti",
            ...
            'Unit Penunjang Akademik Bahasa (UPA Bahasa)' => [
                "Test Kemampuan Bahasa Asing/ English Test Program (ETP) Bagi Mahasiswa Diploma dan Sarjana",
                "Test Kemampuan Bahasa Asing/ English Test Program (ETP) Bagi Mahasiswa PascaSarjana, Profesi dan Umum",
                "Test Kemampuan Bahasa Asing/ Test of English Proficiency (TOEP)",
                "Test Potensi Dasar Akademik (TPDA)",
                "Pelatihan Bahasa Indonesia bagi Penutur Asing (BIPA)",
                "Peminjaman Lab UPA Bahasa dan Multimedia",
                "Kursus Bahasa Inggris",
                "Dari Bahasa Asing ke Indonesia - Dari Bahasa Inggris",
                "Dari Bahasa Asing ke Indonesia - Dari Bahasa Jepang",
                "Dari Bahasa Asing ke Indonesia - Dari Bahasa Mandarin",
                "Dari Bahasa Indonesia Ke Asing - Ke Bahasa Inggris",
                "Dari Bahasa Indonesia Ke Asing - Ke Bahasa Jepang",
                "Dari Bahasa Indonesia Ke Asing - Ke Bahasa Mandarin"
            ],
            'Unit Penunjang Akademik Pengembangan Karir dan Kewirausahaan (UPA PKK)' => [
                "Tracer Study",
                "Informasi Lowongan Pekerjaan",
                "Informasi Pelatihan dan Seminar Karir dan Kewirausahaan",
                "Layanan Pendampingan Kewirausahaan",
                "Job Fair",
            ],
        ];
